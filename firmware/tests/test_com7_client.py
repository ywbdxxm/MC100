...
spec = importlib.util.spec_from_file_location("mc100_com7", Path(__file__).parents[1] / "tools" / "mc100_com7.py")
...
class ClientProtocol(unittest.TestCase):
    ...
    def test_port_is_fixed(self):
        self.assertEqual(client.PORT, "COM7")
    ...
    def test_remote_filename_is_finalized_and_bounded(self):
        ...
        for name in ("../data.wav", "COM7", "a" * 32 + "_1_0.wav.part", "a" * 140):
